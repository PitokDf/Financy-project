...
export default function DashboardPage() {
  ...
  const lastTx = stats?.lastTransactionAt
    ? new Date(stats.lastTransactionAt)
    : null;
  ...
  return (
    <div className="animate-fade-in relative text-foreground">
      <div className="mb-5">
        <div className="flex items-center justify-end gap-1 mb-4">
          <Link
            href="/achievements"
            className="p-2 text-amber-500 hover:bg-amber-500/10 rounded-xl transition-all hover:scale-105 active:scale-95 mr-1 bg-amber-500/5 border border-amber-500/20 shadow-sm shadow-amber-500/10"
          >
            ...
            <Flame
              className={cn(
                ...
                isAtRisk
                  ...
                  : "text-orange-500 fill-orange-500 drop-shadow-[0_0_8px_rgba(249,115,22,0.6)] animate-pulse",
              )}
            />
            <span
              className={cn(
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-white/15 rounded-xl p-3 backdrop-blur-sm">
                ...
                <p className="text-white font-bold text-sm">
                  {formatCurrencyWithSecure(summary.monthlyIncome, isSecure)}
                </p>
              </div>
              <div className="bg-white/15 rounded-xl p-3 backdrop-blur-sm">
                <div className="flex items-center gap-1 mb-1">
                ...
                <p className="text-white font-bold text-sm">
                  {formatCurrencyWithSecure(summary.monthlyExpense, isSecure)}
                </p>
              </div>
            </div>
          </div>
                  ...
                  <div className="flex items-center gap-3">
                    <div
                      className={cn(
                        ...
                        index === 0
                          ? "bg-amber-400 border-amber-300 text-amber-900 shadow-lg shadow-amber-400/30"
                          : index === 1
                ...
                <div className="flex-1">
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <span className="text-xs font-bold text-foreground">
                      {formatCurrencyWithSecure(cat.amount, isSecure)}
                    </span>
                  </div>
