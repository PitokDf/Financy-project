...
import { LogOut, Star, Flame, Award, Trophy } from "lucide-react";
...
export default function ProfilePage() {
  ...
  const { logoutMutation, logoutLoading, profileQuery, loadingQuery } =
    useAuth();
  ...
  const STATS = [
    ...
    },
    {
      ...
      value: userLongestStreak.toString(),
      icon: Trophy,
      color: "text-rose-500",
    },
    {
      label: t("badge"),
      value: userBadgeCount.toString(),
      icon: Award,
      color: "text-primary",
      link: "/achievements",
    },
