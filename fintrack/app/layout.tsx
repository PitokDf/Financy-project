...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Aplikasi manajemen keuangan pribadi dengan klasterisasi transaksi otomatis berbasis AI untuk membantu Anda mencapai kebebasan finansial.",
  ...
  twitter: {
    ...
    description:
      "Aplikasi manajemen keuangan pribadi cerdas dari Indonesia, memaksimalkan klasterisasi AI.",
    creator: "@fintrack_id",
  },
  robots: {
    index: true,
