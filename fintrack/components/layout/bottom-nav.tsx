  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 safe-bottom">
      <div className="glass border-t border-border/40 shadow-[0_-1px_3px_rgba(0,0,0,0.02)]">
        <div className="flex max-w-2xl mx-auto items-center justify-around px-2 h-16">
          {NAV_ITEMS.map((item) => {
            ...
            return (
              <Link
                ...
                href={item.href}
                className={cn(
                  "group relative flex flex-col items-center justify-center min-w-16 h-full transition-all duration-300 active:scale-90",
                  isActive
                    ? "text-primary"
              ...
              >
                ...
                <span
                  className={cn(
                    ...
                    isActive
                      ? "opacity-100"
                      : "opacity-60 text-[9px] font-medium",
                  )}
                >
                  {item.label}
                </span>
