  ...
  return (
    ...
    >
      ...
      <div className="glass border-b border-border/40 px-4 safe-top shadow-sm shadow-black/5">
        <div className="relative max-w-2xl mx-auto flex h-14 items-center justify-between">
          {/* Left & Center Section */}
          <div
            className={cn(
                ...
                {showAvatar && !title && pathname === "/dashboard" ? (
                  <div>
                    <span className="text-[10px] font-medium uppercase tracking-widest text-muted-foreground/80 leading-tight">
                      {greeting}{" "}
                      <span className="inline-block origin-[70%_70%] animate-wave text-lg">
                        👋
                      </span>
                      ,
                    </span>
          ...
          <div className="flex items-center justify-end gap-1.5 min-w-12">
            ...
            {enableProfile && (
              <div
                className="ml-1 active:scale-90 transition-transform cursor-pointer"
