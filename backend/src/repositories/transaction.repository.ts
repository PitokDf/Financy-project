...
export interface TransactionHistoryByCategoryItem {
    amount: number;
    date: Date;
}
...
export class TransactionRepository {
    ...
    static async findExpenseHistoryByCategory(userId: string, categoryId: string): Promise<TransactionHistoryByCategoryItem[]> {
        const transactions = await prisma.transaction.findMany({
            where: {
                userId,
                type: TransactionType.EXPENSE,
